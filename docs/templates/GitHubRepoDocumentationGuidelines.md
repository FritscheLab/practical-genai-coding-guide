...
* **Current Year:** `[Dynamically Insert Current Year]` (As of Mar 28, 2025: 2025)
* **Current Date:** `[Dynamically Insert Current Date]` (As of Mar 28, 2025: 2025-03-28)
...
2.  **Repository Name:** If a repository name was not provided in the inputs, suggest 5 suitable names based on the script analysis and ask the user to choose one. Confirm the final name before proceeding.

**Output Generation:**

1.  Generate the `README.md` file according to the structure specified below.
2.  For *each* script provided, generate a corresponding `/docs/[script_filename_base].md` file using the specified structure.
